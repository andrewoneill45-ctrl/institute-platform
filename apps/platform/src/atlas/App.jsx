...
const App = () => {
  ...
  const handleGoHome = useCallback(() => {  setSearchQuery(''); setActiveFilters(null); setSelectedSchool(null); setCompareList([]); setShowCompare(false); setShowStats(false); setHoveredSchool(null); setHoverPos(null); mapRef.current?.flyTo({ center: [-1.5, 52.8], zoom: 6, duration: 800 }); }, []);
  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative' }}>
      ...
      <div className="atlas-brand" aria-hidden="true">
        <svg viewBox="0 0 100 100" width="15" height="15"><path d="M31.5 31.5 A 18.5 18.5 0 1 1 68.5 31.5 A 18.5 18.5 0 1 1 68.5 68.5 A 18.5 18.5 0 1 1 31.5 68.5 A 18.5 18.5 0 1 1 31.5 31.5 Z" fill="none" stroke="#6A0CA0" strokeWidth="9"/></svg>
        <span>Atlas</span>
      </div>
